...
class Socket:
    ...
    # make a connection between the server and the client
    def connect(self):
...
# download the video file from Google Drive using Drive API
...
def main():
    # Initialize the host and port, connect to the client
